...
import com.ai.assistance.operit.ui.features.game.screens.GameSetupScreen
import com.ai.assistance.operit.ui.features.game.screens.GameChatScreen
...
sealed class Screen(
    ...
    data object GameSetup : Screen(navItem = NavItem.GameSetup, titleRes = R.string.nav_game_setup) {
        @Composable
        override fun Content(
                navController: NavController,
                navigateTo: ScreenNavigationHandler,
            ...
            GameSetupScreen(
                    onGoBack = onGoBack,
                    onStartGame = { gameIntro, gameSettings, characterSettings, difficulty ->
                        navigateTo(
                                GameChat(
                                        gameIntro = gameIntro,
    ...
    data class GameChat(
        val gameIntro: String,
        val gameSettings: String = "",
        val characterSettings: String = "",
        val difficulty: String = ""
    ) : Screen(navItem = NavItem.GameSetup, titleRes = R.string.nav_game_setup) {
        @Composable
        override fun Content(
                navController: NavController,
                navigateTo: ScreenNavigationHandler,
